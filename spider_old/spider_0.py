...
def main() :
    ...
    global count
    threads = []
    url = "http://channel.chinanews.com/cns/s/channel:ty.shtml?pager=0&pagenum=100&_=1509206249286"
    for i in range(0,1000) :  #向队列中放入任务
        url = 'http://channel.chinanews.com/cns/s/channel:ty.shtml?pager=' + str(i) + '&pagenum=100&_=1509206249286'
        urls_queue.put(url)
