...
def main() :
    ...
    global count
    threads = []
    url = "http://channel.chinanews.com/cns/s/channel:gn.shtml?pager=1&pagenum=100&_=1509182320772"
    for i in range(0,10) :  #向队列中放入任务
        url = 'http://channel.chinanews.com/cns/s/channel:gn.shtml?pager=' + str(i) + '&pagenum=100&_=1509182320772'
        urls_queue.put(url)
