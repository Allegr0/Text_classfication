...
def main() :
    ...
    global count
    threads = []
    url = "http://channel.chinanews.com/cns/s/channel:auto.shtml?pager=0&pagenum=100&_=1509207569959"
    for i in range(0,1000) :  #向队列中放入任务
        url = 'http://channel.chinanews.com/cns/s/channel:auto.shtml?pager=' + str(i) + '&pagenum=100&_=1509207569959'
        urls_queue.put(url)
