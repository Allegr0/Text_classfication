...
def main() :
    ...
    global count
    threads = []
    url = "http://channel.chinanews.com/cns/s/channel:life.shtml?pager=0&pagenum=100&_=1509201938117"
    for i in range(0,1000) :  #向队列中放入任务
        url = 'http://channel.chinanews.com/cns/s/channel:life.shtml?pager=' + str(i) + '&pagenum=100&_=1509201938117'
        urls_queue.put(url)
